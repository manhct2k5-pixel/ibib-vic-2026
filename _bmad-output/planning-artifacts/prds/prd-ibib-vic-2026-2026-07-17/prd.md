...
- **[Mức co]** chỉ BM25 + LLM nếu cháy giờ; **[Đầy đủ]** thêm dense vector + RRF.
...
- **Không dựng graph DB (Neo4j) hay vector DB server (Qdrant)** — dùng in-memory/nhúng (chi tiết ở brief addendum).
